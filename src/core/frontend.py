...
class YOLO(object):
    ...
    def load_weights(self, weight_path):
        self.mgpu_model.load_weights(weight_path)
    ...
    def train(self, train_imgs,     # the list of images to train the model
        ...
        self.mgpu_model.compile(loss=self.custom_loss, optimizer=optimizer)
        ...
        self.mgpu_model.fit_generator(generator = train_generator, 
